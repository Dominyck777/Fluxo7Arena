  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div
          className="group pl-4 pr-4 py-1.5 rounded-lg border border-white/10 bg-gradient-to-b from-surface-2/60 to-surface/60 text-text-primary flex items-center gap-3 shadow-sm hover:border-white/20 transition-colors"
